...
function AboutModal({ onClose, isLight, textMain }: any) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
      <div className={`${isLight ? 'bg-white shadow-[0_0_40px_rgba(0,0,0,0.1)]' : 'bg-slate-900 shadow-[0_0_50px_rgba(0,0,0,0.5)]'} rounded-2xl md:rounded-[3rem] w-full max-w-6xl p-6 md:p-10 lg:p-14 border ${isLight ? 'border-slate-300' : 'border-slate-800'} relative overflow-hidden max-h-[98vh] flex flex-col justify-center`}>
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center justify-center h-full">
          <div className="relative w-48 h-48 md:w-80 md:h-80 lg:w-[500px] lg:h-[500px] group shrink-0">
          ...
          <div className="flex-1 flex flex-col justify-center space-y-10 md:space-y-14 text-center md:text-left py-2">
             <div className="space-y-8 md:space-y-10">
                <p className={`${isLight ? 'text-slate-950' : 'text-white'} text-xl md:text-3xl lg:text-4xl xl:text-5xl font-thin leading-snug opacity-90 tracking-tight md:tracking-soft`}>
                  "O aplicativo pra ajudar a recordar a memória de quem nos trouxe até aqui."
                </p>
                <div className="h-0.5 w-full bg-gradient-to-r from-transparent via-indigo-600 to-transparent opacity-60"></div>
             </div>
             ...
             <div className="flex items-center justify-center md:justify-start gap-4">
                <span className="text-yellow-500 font-extralight text-2xl md:text-4xl lg:text-5xl xl:text-6xl tracking-elegant uppercase inline-flex items-center gap-4 lg:gap-8 whitespace-nowrap">
                  ...
                  <Heart className="w-8 h-8 md:w-12 md:h-12 lg:w-16 lg:h-16 xl:w-20 xl:h-20 fill-current text-indigo-600 animate-pulse" />
                </span>
             </div>
          </div>
        </div>
